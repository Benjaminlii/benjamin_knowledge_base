...
<!--    <classPathEntry location="E://repository-p2p//mysql//mysql-connector-java//5.1.43//mysql-connector-java-5.1.43.jar"/>-->
    ...
    <context id="default" targetRuntime="MyBatis3">
        ...
        -->
        <javaModelGenerator targetPackage="com.Benjamin.p2p.model"
        ...
        <sqlMapGenerator targetPackage="com.Benjamin.p2p.mapper"
                         targetProject="src/main/java">
            <property name="enableSubPackages" value="false"/>
        </sqlMapGenerator>
        ...
        -->
        <javaClientGenerator targetPackage="com.Benjamin.p2p.mapper"
...
```
//db.properties文件
jdbc.driverLocation=/media/benjamin/Data/Java/jar/jdbc/mysql-connector-java-5.1.6.jar
jdbc.driverClass=com.mysql.jdbc.Driver
jdbc.connectionURL=jdbc:mysql://localhost:3306/p2p?characterEncoding=utf-8&serverTimezone=UTC
jdbc.userId=root
jdbc.password=litao.
```
